...
data class UserData(
    ...
    constructor(studentID: String, password: String, loginStatus: Boolean) : this(studentID, password, projects = mutableListOf(), schedules = mutableListOf(), loginStatus = false)
